...
while speech != number :
  random_speech_1 = random.choice(speech_1)
  random_speech_2 = random.choice(speech_2)
  random_speech_3 = random.choice(speech_3)
  random_speech_4 = random.choice(speech_4)
  random_speech_5 = random.choice(speech_5)
  r = (random_speech_1 + random_speech_2 + random_speech_3 + random_speech_4 + random_speech_5)
  speech += 1
  print (r)
